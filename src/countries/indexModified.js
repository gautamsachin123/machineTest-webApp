...
import { Button, Pager, Col, Checkbox,ControlLabel, FormControl, FormGroup} from "react-bootstrap";
...
class CountriesList extends Component {
 ...
 default = ["name","capital","area","region","demonym"];
  ...
  componentWillMount() {
    let result = this.fetchCountries();
  }

  fetchCountries = () => {
   let result =  this.props.fetchCountriesRequest(
